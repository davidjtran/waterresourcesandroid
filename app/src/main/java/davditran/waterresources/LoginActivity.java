...
//    private UserLoginTask mAuthTask = null;
    ...
    private User user;
    private static final SerializationController serializationController = new SerializationController();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        serializationController.retrieveAll(this);
        userList = serializationController.users;
